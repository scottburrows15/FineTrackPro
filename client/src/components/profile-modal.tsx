...
export default function ProfileModal({ isOpen, onClose }: ProfileModalProps) {
  ...
  if (isLoading) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="w-full max-w-[95vw] sm:max-w-md p-4 sm:p-6 bg-white dark:bg-slate-800 border-border">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-[95vw] sm:max-w-md p-4 sm:p-6 max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-800 border-border" aria-describedby="profile-description">
        <DialogHeader>

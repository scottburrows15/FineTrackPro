...
import { User, Save, Upload, Camera, ArrowLeft, Users, Shield, Check, ChevronRight, Loader2 } from "lucide-react";
                ...
                {teamsLoading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      ...
                      className="w-full mt-3 border-dashed border-blue-300 dark:border-blue-700 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                      data-testid="button-create-new-team"
                    >
